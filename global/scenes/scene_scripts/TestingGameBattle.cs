...
public partial class TestingGameBattle : Node2D{
	...
	public void GenerateTestTeam(){
		Entity[] fighterDatas = new Entity[] {
			ResourceLoader.Load<Entity>("res://data/entities/SlimeDreamer.tres"),
			ResourceLoader.Load<Entity>("res://data/entities/SlimeDreamer.tres"),
			ResourceLoader.Load<Entity>("res://data/entities/SlimeDreamer.tres"),
			ResourceLoader.Load<Entity>("res://data/entities/SlimeDreamer.tres")
		};
		teamEnemy.CreateTeam(fighterDatas,true);
	}
	...
	public void GenerateBattleOponents(){
		...
		GenerateTestTeam();
		TTS.PutThisInQueue($"Equipo test generado");
