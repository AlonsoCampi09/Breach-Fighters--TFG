...
public partial class CinematicaInicial : Node2D
{
	...
	public void Escena() {
		...
		if (CustomSignals.activado) DisplayServer.TtsSpeak(mensaje, CustomSignals.Instance.voiceId, CustomSignals.volumenTextToSpeach, 1, CustomSignals.velocidadTextToSpeach);
